...
#     print('Can not divded by 0')

# else:
#     print('The result is :{result}')
#     print('Successfully devided')
# finally:
#     print('The end')
...
# try:
#     anum = int (input('Enter your age:'))
#     assert 0< anum < 120, 'Age cannot will be in the rage of 0 to 120'
...
#     opra = input('Enter opration like +, -.*,/,<,>,//,==:')
...
#     bnum = int (input('Enter second number:'))
#     opra = input('Enter opration like +, -.*,/,<,>,//,==:')
#     inum = int (input('Enter the index in list for result:'))
...
# try:
#     anum = int (input('Enter temperature in Celcious:'))
#     assert 0< anum < 120, 'temperature will be in the rage of 0 to 120'
#     result = (anum * 9/5) + 32
